...
| 专栏 | 文件 | 核心一句话 |
|------|------|------------|
| **LangChain** | [COLUMN_LANGCHAIN.md](./COLUMN_LANGCHAIN.md) | Runnable + LCEL + 消息/Prompt/检索/工具 — **零件与直线编排** |
| **LangGraph** | [COLUMN_LANGGRAPH.md](./COLUMN_LANGGRAPH.md) | State + Node + 边 — **分支与循环（典型 Agent）** |
